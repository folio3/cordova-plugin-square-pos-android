...
Note: this plugin is modified version of [darryncampbell-cordova-plugin-intent](https://github.com/darryncampbell/darryncampbell-cordova-plugin-intent). It can handle the intent creation for Square POS app.
...
## Integration with Square POS Android App
    ...
    plugins.intentShim.startActivityForResult({action: "com.squareup.register.action.CHARGE", package: "com.squareup",
                                          ...
                                          'com.squareup.pos.TOTAL_AMOUNT': 100,
                                          'com.squareup.pos.CURRENCY_CODE': "USD",
                                          'com.squareup.pos.TENDER_TYPES': "com.squareup.pos.TENDER_CARD , com.squareup.pos.TENDER_CARD",
                                          },
                                        },
                                          function(intent) {console.log("Success callback"); console.log(JSON.stringify(intent));},
